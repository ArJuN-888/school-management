    ...
    <div className='text-center backgr'>
        <div className='text-center'>
            <div className='img-container'>
                <img className='text-center contact-img' src="https://www.naipunnyacollege.ac.in/NAIPUPLOADS/innerbanner_thumb/1705912361_Common_Banner01.jpg" alt='img'/>
            </div>
        </div>
        ...
        <div className='con-items'>
            ...
            <div className='text-center simple'>
                ...
                <p className='con-add text-center'>
                    Near Manorama Junction, Cherthala<br/>
                    Affiliated to the University of Kerala,<br/>
                    A Project of the Archdiocese of Ernakulam-Angamaly<br/>
                </p>
            </div>
            <div className='simple'>
                <div className='ad'>
